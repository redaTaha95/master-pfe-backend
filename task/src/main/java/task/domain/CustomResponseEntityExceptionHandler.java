...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleTaskNotFoundException(TaskNotFoundException ex, ServerWebExchange exchange) {
    ...
    public ResponseEntity<Object> handleProjectNotFoundException(ProjectNotFoundException ex, ServerWebExchange exchange) {
        String error = ex.getMessage();
        ErrorResponse errorResponse = new ErrorResponse(HttpStatus.NOT_FOUND, error);
        return handleExceptionInternal(ex, errorResponse, null, HttpStatus.NOT_FOUND, exchange).block();
    }
